...
SET Grade_Point = CASE
		WHEN Score BETWEEN 70 AND 100 THEN 4
		WHEN Score BETWEEN 60 AND 69 THEN 3
		WHEN Score BETWEEN 50 AND 59 THEN 2
		WHEN Score BETWEEN 45 AND 49 THEN 1
	ELSE 0
	END
...
SELECT TOP 10 Student_ID, AVG(CGPA) AS Avg_CGPA
FROM Records
GROUP BY Student_ID
ORDER BY Avg_CGPA DESC
